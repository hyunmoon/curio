...
test('production component uses the bounded controller and display clock', () => {
  ...
  for (const token of ['new ClusterTaskPollController(', "'ClusterTaskSummaryLimited'", 'new ClusterTaskFreshnessTicker(', 'resetClusterTaskDisplayClock(this.monotonicNow())', 'freezeClusterTaskDisplayClock(this.displayClock)', 'personalTaskAge(entry, this.displayClock)']) {
